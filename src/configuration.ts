...
export class Configuration implements IConfiguration {
    public extensionVersion: string = '0.10.9'; // TODO Un-hard-code this.
    ...
    public get telemetryDisabled(): boolean {
        return workspaceConfiguration.get<boolean>('edi-x12.telemetry.disabled', false) || !workspaceConfiguration.get<boolean>('telemetry.enableTelemetry', true);
    }
}